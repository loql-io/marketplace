    ...
    <div className="wrapper">
      ...
      <div className="faq-wrapper">
        <p className="centered">
          Loql helps communities become more resilient by putting power back in
        ...
        <div className="container">
          ...
          <div className="image">
            ...
            <section>
              ...
              <p>
                One rich digital destination that showcases what makes the real
                high street so good.
              </p>
              <br />
              <h3 className="h-m">Cost-effective food ordering</h3>
              <p>
                A full featured food ordering platform for delivery, takeaway or
                eat in orders.
              </p>
              <br />
              <h3 className="h-m">Powerful tools for retailers</h3>
              <p>
                Create subscriptions, issue discounts, provide gift cards, for
                one store or all.
              </p>
            </section>
          </div>
      ...
      <div className="setup-wrapper white-bg">
        <div className="container">
          ...
          <h3 className="h-l">
            A range of electric vehicles that bring people and things together
            in a more affordable and environmentally-friendly way
          </h3>
          ...
          <div className="image">
            ...
            <section>
              ...
              <p>
                Look out for our incredible new delivery vehicles in your high
                street soon!
              </p>
              <br />
              <h3 className="h-m">Shared distribution</h3>
              <p>
                We believe that by pooling supply and demand for delivery, we
                can make it affordable - while rewarding drivers fairly.
              </p>
              <br />
          ...
          <section className="collapsible-grid-container">
            <div className="group">
              ...
              <div className="content">
                <p>
                  We create and integrate tools and services for communities to
                  use together. We take the complexity out of adopting new
                  technologies and ways of doing things but also greatly reduce
                  the cost by spreading it across numerous communities.
                </p>
              </div>
              ...
              <div className="content">
                <p>
                  We currently have a pilot community operating in Berkhamsted,
                  Herts. If you are a business business in the town please get
                  in touch with Berkhamsted Loql for more information about
                  joining.
                </p>
              </div>
            </div>
            <div className="group">
              <button className="collapsible">Where are you going next?</button>
              <div className="content">
                <p>
                  We will be looking to establish Loql communities in towns
                  across the UK over the coming months and years. If you are
                  interested in helping start a community in your area please
                  contact our Communities team
                </p>
              </div>
              <button className="collapsible">
              ...
              <div className="content">
                <p>
                  ...
                  rewarding on a personal and collective level. We’re also a not
                  for profit so we only take what we need to operate and any
                  additinal income goes straight into developing even better
